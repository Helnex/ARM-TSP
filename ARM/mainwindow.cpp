...
//ui->Employee_tableWidget->setItem(e_i, 0, new QTableWidgetItem(QString::fromStdString(emp.FIO)));
    ...
    {
        //ui->Employee_tableWidget->setItem(e_i, 0, new QTableWidgetItem(QString::fromStdString(emp.FIO)));
        ui->Employee_tableWidget->setItem(e_i, 0, new QTableWidgetItem("Кобзев С.И."));
...
void MainWindow::on_poses_listWidget_currentItemChanged(QListWidgetItem *current, QListWidgetItem *previous)
{
